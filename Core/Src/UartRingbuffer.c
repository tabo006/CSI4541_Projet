...
int Wait_for (char *string)
{
	int so_far =0;
	int len = strlen (string);
    char response_buffer[100]; // Store incoming response
...
again:
    ...
    response_buffer[response_index] = '\0'; // Null-terminate string

    printf("%c", received_char); // Print each received character
